...
const Footer = ({ shouldShow } : FooterProps) => {
    return shouldShow && (
        <footer className="py-5 bg-sku-light justify-center flex flex-col">
            ...
            <a className="underline" href="https://www.privacypolicygenerator.info/live.php?token=eaddASETVbpEK8Y4s6cKeKxiScckYu8T" rel="noopener noreferrer" target="_blank" aria-label="link to privacy policy"><small>Privacy Policy</small></a>
